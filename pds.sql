...
/*
 ...
 employees упорядковано за іменами за зростанням.
 */
select  * from `employees` order by `FIRST_NAME`

# Task2
/*
 Напишіть запит, щоб отримати імена (ім'я, прізвище), зарплату та
 податки усіх співробітників (податки розраховуються як 15% від зарплати).*/

select `FIRST_NAME`, `LAST_NAME`, `SALARY`,
ROUND((`SALARY` * 15/100), 2) as `tax`
from `employees`
# Task3
/*
 Напишіть запит, щоб отримати загальну суму заробітної плати всіх
 співробітників.*/
select SUM(`SALARY`) as `sum` from `employees`

# Task4
/*
 Напишіть запит для отримання максимальної та мінімальної
...
/*
 ...
 працівників у таблиці employees.*/
